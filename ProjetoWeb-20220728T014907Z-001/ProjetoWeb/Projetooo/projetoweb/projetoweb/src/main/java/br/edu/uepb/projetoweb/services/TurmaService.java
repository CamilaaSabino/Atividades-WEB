...
import br.edu.uepb.projetoweb.repositories.TurmaRepository;
...
public class TurmaService {
	...
	public Turma buscarTurma(Long turmaID) throws NotFoundException {
		return turmaRepository.findById(turmaID).orElseThrow(() -> new NotFoundException("Não existe um turma com esse identificador!"));
	}
