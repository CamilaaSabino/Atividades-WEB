...
import br.edu.uepb.projetoweb.services.TurmaService;
...
public class TurmaController {
	...
	@GetMapping()
	@ApiOperation(value = "Retornar a lista de todas as turmas cadastrados.")
	...
	@PostMapping
	@ApiOperation(value = "Cadastrar uma nova turma.")
	...
	@GetMapping("/{id}")
	@ApiOperation(value = "Retornar uma turma pelo seu identificador.")
